...
| `chat-control`        | Control the bot with chat messages                                                                 | AlexProgrammerDE | GPL-3.0 |
| `auto-reconnect`      | Automatically reconnects bots when they time out or are kicked                                     | AlexProgrammerDE | GPL-3.0 |
| `auto-register`       | Automatically registers bots on servers                                                            | AlexProgrammerDE | GPL-3.0 |
...
| `chat-message-logger` | Logs all received chat messages to the terminal                                                    | AlexProgrammerDE | GPL-3.0 |
| `server-list-bypass`  | Bypasses server list anti-bots                                                                     | AlexProgrammerDE | GPL-3.0 |
...
| `pov-server`          | A plugin that allows users to control bots from a first-person perspective.                        | AlexProgrammerDE | GPL-3.0 |
