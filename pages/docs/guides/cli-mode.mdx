...
```bash
java -Xmx$RAM -XX:+UnlockExperimentalVMOptions -XX:+UseG1GC -XX:G1NewSizePercent=20 -XX:G1ReservePercent=20 -XX:MaxGCPauseMillis=50 -XX:G1HeapRegionSize=32M -jar SoulFireClient.jar --address 127.0.0.1:25565 --amount 100 --protocol-version 1.20 --join-min-delay 1000 --join-max-delay 3000
```
