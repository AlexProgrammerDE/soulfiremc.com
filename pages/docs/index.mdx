...
SoulFire is a plugin that restores skins for offline mode servers & networks that gives the players the ability to
change their skins by typing a single command. In addition, SoulFire allows caching skins on larger networks.
