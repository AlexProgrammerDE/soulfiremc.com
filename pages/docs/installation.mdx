...
# Installing ServerWrecker

## Creator notes

Here you can find everything you need for your first time installation of ServerWrecker as well as the recommended way
of doing so.
If you're having issues or questions while installing, feel
free to ask questions on our [discord server](https://serverwrecker.net/discord).

## Requirements

To be able to use ServerWrecker on your server, little is needed:
...
issues? > [troubleshoot connection](/docs/troubleshooting))
* Minecraft server versions and variants that we
support [[check overview](https://github.com/AlexProgrammerDE/ServerWrecker/blob/HEAD/README.md#telescope-compatibility)]

## Platform Installation

In this section, you can read how to set up our plugin ServerWrecker your for Minecraft Server/Network!
