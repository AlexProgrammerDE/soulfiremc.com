...
To be able to use SoulFire on your server, little is needed:
...
support [[check overview](https://github.com/AlexProgrammerDE/SoulFire/blob/HEAD/README.md#telescope-compatibility)]

## Platform Installation

In this section, you can read how to set up our plugin SoulFire your for Minecraft Server/Network!
