...
import {BoltIcon, CloudArrowDownIcon, CubeTransparentIcon, RocketLaunchIcon, Squares2X2Icon} from "@heroicons/react/24/solid";
...
export function mapAssetName(name) {
    if (name.includes(".jar")) return "Universal (.jar)"
    if (name.includes(".msi")) return "Windows (.msi)"
    if (name.includes(".pkg") || name.includes(".dmg")) return "macOS (.pkg)"
...
export const LatestRelease = () => {
    ...
    return (
        <div
            ...
            <div className="flex max-md:flex-wrap md:flex-row gap-4 justify-start">
                <div className="flex flex-col flex-shrink-0">
                    ...
                    <div className="flex flex-wrap gap-1">
                        <a
                            ...
                            <span>{mapAssetName(latest.assets[0].name)}</span>
                        </a>
                    </div>
                </div>
                <div className="flex flex-col flex-grow-0">
                    ...
                    <div className="grid grid-cols-2 gap-2 justify-start justify-items-start">
                        {
                            latest.assets.slice(1).map(asset => (
                                <a
                                    href={asset.url}
                                    key={asset.name}
