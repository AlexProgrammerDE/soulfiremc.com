...
export const getStaticProps = ({params}) => {
    return fetch(`https://api.github.com/repos/AlexProgrammerDE/ServerWrecker/releases/latest`)
        .then(res => res.json())
        .then(release => ({
            props: {
                ssg: {
            ...
            <div className="p-4 flex flex-col">
                <div className="mt-8 md:mt-16 flex flex-col md:flex-row mx-auto gap-2">
                    <Image src="/logo.png" width={128} height={128} className="w-24 md:w-16 h-24 md:h-16 mx-auto"
                           alt="ServerWrecker Logo"/>
                    <h1 className="my-auto text-center text-5xl font-bold">
                        ServerWrecker
                    </h1>
                </div>
                <p className="text-center mt-2 text-lg"> Advanced Minecraft Server-Stresser Tool.<br/>Launch bot attacks on your servers to measure performance. </p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 mt-8 md:mt-16">
                    ...
                    >
                        <FeatureCard
                            title="Easy to use"
                            description="ServerWrecker is easy to use, just install it and you're ready to go!"
                    ...
                    <FeatureCard
                        ...
                        description="ServerWrecker can restore your skins on offline mode servers!"
                    ...
                    <a href={process.env.NEXT_PUBLIC_GITHUB_LINK}>
                        <FeatureCard
                            title="Open Source"
                            description="ServerWrecker is open source, you can contribute to it on GitHub!"
                    ...
                    <FeatureCard
                        title="Use our GUI"
                        description={<span>ServerWrecker has a GUI to change your skin, just run <code
