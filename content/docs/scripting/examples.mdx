...
**Connections:**
```
[On Chat] --exec--> [Contains] --exec--> [Branch]
                                           |
                                     true: [Send Chat]
```
...
**Connections:**
```
[On Death] --exec--> [Wait] --exec--> [Send Chat]
              |
              └--exec--> [Discord Webhook]
```
...
**Connections:**
```
[On Interval] --exec--> [Modulo] --data--> [Switch]
                                              |
                                  case 0: [Pathfind To (100, 64, 200)]
                                  case 1: [Pathfind To (150, 64, 250)]
                                  case 2: [Pathfind To (100, 64, 300)]
```
...
**Connections:**
```
[On Bot Init] --exec--> [Find Block] --exec--> [Branch]
                              ^                    |
                              |              found: [Pathfind To] --exec--> [Break Block] --exec--> [Wait]
                              |                                                                        |
                              └------------------------------------------------------------------------┘
```
