...
| `session start{:bash}`                                                | Makes selected instances start a session                                                                                            |
| `session stop{:bash}`                                                 | Makes selected instances stop their session                                                                                         |
| `session pause{:bash}`                                                | Makes selected instances pause their session                                                                                        |
| `online{:bash}`                                                       | Shows connected bots in sessions                                                                                                    |
