...
<Callout type="info">
  SoulFire runs on the **latest Minecraft version** but supports connecting to **Bedrock Edition**, all **Classic**, **Alpha**, **Beta**, **Release** versions, and **April Fools snapshots** through [ViaFabricPlus](https://github.com/ViaVersion/ViaFabricPlus).
</Callout>

SoulFire supports a wide range of Minecraft versions thanks to ViaFabricPlus and its underlying Via* libraries.
SoulFire itself always runs on the latest stable release of Minecraft, and all connections to older versions are translated automatically.
Below is a list of all versions that are supported by SoulFire.

## How does this work?

Thanks to the built-in [ViaFabricPlus](https://github.com/ViaVersion/ViaFabricPlus) mod (which includes [ViaVersion](https://github.com/ViaVersion/ViaVersion),
