...
This guide takes the shortest path to a real plugin that SoulFire will actually load.
It uses the official template instead of starting from an empty Fabric project, because the template already includes the SoulFire-specific Fabric, Loom, and plugin wiring.
