...
WebDAV (Web Distributed Authoring and Versioning) lets you access your SoulFire files over the network.
This page shows you how to connect from Windows, macOS, and Linux.

Make sure SoulFire is already installed and running on your machine before you start.
If it isn't, head to [Start Here](/docs/start-here).

## What can you do with WebDAV?

WebDAV lets you access and manage files on a remote server as if they were sitting on your local machine.
