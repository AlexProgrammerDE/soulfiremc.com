...
<Callout type="info">
  Stay in scripting if you can.
  Move to [Development](/docs/development) only when you need something lower-level than the node system can express, such as Mixins, packet interception, custom settings pages, or direct Minecraft and SoulFire object access.
</Callout>
