...
For serious plugin work, treat SoulFire like an API plus a source tree, not just a jar dependency.
You will move faster if your local environment lets you inspect the current implementation, the built-in plugins, and the generated Javadocs side by side.
