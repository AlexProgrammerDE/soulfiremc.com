...
**Lore/Story NPC**
```text title="Example Interaction"
...
```text title="Moderation Features"
...
<Tabs items={["OpenAI GPT", "Anthropic Claude", "Ollama"]}>
...
```bash title="Download and Install Plugin"
# Download plugin
...
```text title="Example Chat Interactions"
...
```json title="creature-chat-config.json"
{
  "entities": {
    "villager": {
      "enabled": true,
...
```text title="Basic Functionality Test"
...
```text title="Quality Test Queries"
...
```text title="Context Awareness Test"
...
```text title="Content Filtering Test"
...
```text title="Language Support Test"
...
```text title="Pattern Detection Examples"
...
```text title="Response Time Benchmark"
...
```text title="Concurrent Load Test"
...
```text title="Context Persistence Test"
...
```text title="Spam Prevention Test"
...
```text title="Content Filter Test"
...
```text title="Basic Bot Test Setup"
Setup:
- 5 bots connected
...
```text title="Performance Benchmark Results"
...
```text title="Stress Test Results"
