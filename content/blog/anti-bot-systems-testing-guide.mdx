...
<Callout type="info">
The configuration examples below are for reference purposes. Always consult the [official EpicGuard documentation](https://github.com/4drian3d/EpicGuard) for the most up-to-date configuration options and best practices.
</Callout>
...
<Callout type="info">
The configuration examples below are for reference purposes. Always consult the official UltimateAntiBot documentation for the most up-to-date configuration options and best practices.
</Callout>
...
<Callout type="info">
The configuration examples below are for reference purposes. Always consult the official BotSentry documentation for the most up-to-date configuration options and best practices.
</Callout>
