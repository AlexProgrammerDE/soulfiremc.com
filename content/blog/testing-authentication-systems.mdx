...
For online-mode servers or premium account verification:
...
**WARNING:** Only test on your own server with permission.
...
**If successful (BAD!):** SQL injection vulnerability exists. Update AuthMe immediately.
