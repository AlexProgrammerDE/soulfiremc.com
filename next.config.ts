...
const securityHeaders = [
  ...
  },
  {
    ...
    value:
      "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://*.posthog.com https://analytics.ahrefs.com https://e.soulfiremc.com; style-src 'self' 'unsafe-inline' https://*.posthog.com; object-src 'none'; base-uri 'self'; connect-src 'self' https://discord.com https://*.posthog.com https://analytics.ahrefs.com https://e.soulfiremc.com; font-src 'self' https://*.posthog.com; frame-src 'self' https://www.youtube.com; img-src 'self' data: https://avatars.githubusercontent.com https://img.shields.io https://*.posthog.com; manifest-src 'self'; media-src 'self' https://github.com https://github-production-user-asset-6210df.s3.amazonaws.com https://*.posthog.com; worker-src 'self' blob: data:;",
  },
];
